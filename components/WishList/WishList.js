    ...
    <TouchableOpacity style={styles.container} onPress={onPressView} testID={testID}>
      <View style={styles.detailContainer}>
        ...
        <View style={styles.categoryInfo}>
          <Text style={styles.categoryTitle} testID={testID ? `${testID}-title` : undefined}>{title}</Text>
          <Text style={styles.categoryDescription} testID={testID ? `${testID}-description` : undefined}>{`${description.substring(
            0,
            30
          )}..`}</Text>
        </View>
