...
const ViewCategoryScreen = ({ navigation, route }) => {
  ...
  return (
    <View testID="view-categories-screen" style={styles.container}>
      <ProgressDialog visible={isloading} label={label} />
      <StatusBar testID="view-categories-status-bar"></StatusBar>
      <View style={styles.TopBarContainer}>
        <TouchableOpacity
          testID="view-categories-back-btn"
          onPress={() => {
            navigation.goBack();
          }}
        >
        ...
        <TouchableOpacity
          testID="view-categories-add-btn"
          onPress={() => {
      ...
      <View style={styles.screenNameContainer}>
        <View>
          <Text testID="view-categories-heading" style={styles.screenNameText}>View Categories</Text>
        </View>
        <View>
          <Text testID="view-categories-subtitle" style={styles.screenNameParagraph}>View all Categories</Text>
        </View>
      </View>
      <CustomAlert testID="view-categories-alert" message={error} type={alertType} />
      <CustomInput
        testID="view-categories-search-input"
        radius={5}
        placeholder={"Search..."}
        value={filterItem}
      ...
      >
        {foundItems && foundItems.length == 0 ? (
          <Text testID="view-categories-empty-text">{`No category found with the title of ${filterItem}!`}</Text>
        ) : (
