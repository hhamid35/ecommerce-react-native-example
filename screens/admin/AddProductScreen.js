...
const AddProductScreen = ({ navigation, route }) => {
  ...
  return (
    <KeyboardAvoidingView style={styles.container} testID="add-product-screen">
      <StatusBar testID="add-product-status-bar"></StatusBar>
      <ProgressDialog visible={isloading} label={"Adding ..."} />
      <View style={styles.TopBarContainer}>
        <TouchableOpacity
          testID="add-product-back-btn"
          onPress={() => {
      ...
      <View style={styles.screenNameContainer}>
        <View>
          <Text style={styles.screenNameText} testID="add-product-heading">Add Product</Text>
        </View>
        <View>
          <Text style={styles.screenNameParagraph} testID="add-product-subtitle">Add product details</Text>
        </View>
      </View>
      <CustomAlert message={error} type={alertType} testID="add-product-alert" />
      <ScrollView
        testID="add-product-scroll"
      ...
      >
        <View style={styles.formContainer}>
          <View style={styles.imageContainer}>
            {image ? (
              <TouchableOpacity style={styles.imageHolder} onPress={pickImage} testID="add-product-image-picker">
                <Image
                  source={{ uri: image }}
                  style={{ width: 200, height: 200 }}
                  testID="add-product-image-preview"
                />
              </TouchableOpacity>
            ) : (
              <TouchableOpacity style={styles.imageHolder} onPress={pickImage} testID="add-product-image-picker">
          ...
          <CustomInput
            ...
            placeholderTextColor={colors.muted}
            radius={5}
            testID="add-product-title-input"
          />
          <CustomInput
            value={price}
            setValue={setPrice}
      ...
      <DropDownPicker
        ...
        testID="add-product-category-dropdown"
      />
      <View style={styles.buttomContainer}>
        <CustomButton text={"Add Product"} onPress={addProductHandle} testID="add-product-submit-btn" />
      </View>
    </KeyboardAvoidingView>
  );
};
