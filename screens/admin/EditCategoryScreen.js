...
const EditCategoryScreen = ({ navigation, route }) => {
  ...
  return (
    <KeyboardAvoidingView testID="edit-category-screen" style={styles.container}>
      <StatusBar testID="edit-category-status-bar"></StatusBar>
      <ProgressDialog visible={isloading} label={"Adding ..."} />
      <View style={styles.TopBarContainer}>
        <TouchableOpacity
          testID="edit-category-back-btn"
          onPress={() => {
      ...
      <View style={styles.screenNameContainer}>
        <View>
          <Text testID="edit-category-heading" style={styles.screenNameText}>Edit Category</Text>
        </View>
        <View>
          <Text testID="edit-category-subtitle" style={styles.screenNameParagraph}>Add Edit details</Text>
        </View>
      </View>
      <CustomAlert testID="edit-category-alert" message={error} type={alertType} />
      <ScrollView
        testID="edit-category-scroll"
        showsVerticalScrollIndicator={false}
        style={{ flex: 1, width: "100%" }}
      >
        <View style={styles.formContainer}>
          <CustomInput
            testID="edit-category-title-input"
            value={title}
            setValue={setTitle}
            placeholder={"Title"}
          ...
          <CustomInput
            testID="edit-category-description-input"
            value={description}
      ...
      <View style={styles.buttomContainer}>
        <CustomButton
          testID="edit-category-submit-btn"
          text={"Edit Category"}
          onPress={() => {
