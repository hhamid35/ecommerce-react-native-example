...
const ViewProductScreen = ({ navigation, route }) => {
  ...
  return (
    <View testID="view-products-screen" style={styles.container}>
      <ProgressDialog visible={isloading} label={label} />
      <StatusBar testID="view-products-status-bar"></StatusBar>
      <View style={styles.TopBarContainer}>
        <TouchableOpacity
          testID="view-products-back-btn"
          onPress={() => {
            navigation.goBack();
          }}
        >
      ...
      <View style={styles.screenNameContainer}>
        <View>
          <Text testID="view-products-heading" style={styles.screenNameText}>View Product</Text>
        </View>
        <View>
          <Text testID="view-products-subtitle" style={styles.screenNameParagraph}>View all products</Text>
        </View>
      </View>
      <CustomAlert testID="view-products-alert" message={error} type={alertType} />
      <CustomInput
        testID="view-products-search-input"
        radius={5}
        placeholder={"Search..."}
        value={filterItem}
      ...
      >
        {foundItems && foundItems.length == 0 ? (
          <Text testID="view-products-empty-text">{`No product found with the name of ${filterItem}!`}</Text>
        ) : (
