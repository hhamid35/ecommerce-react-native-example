...
const CategoriesScreen = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.container} testID="categories-screen">
      <StatusBar testID="categories-status-bar"></StatusBar>
      <View style={styles.topBarContainer}>
        <TouchableOpacity
          testID="categories-back-btn"
          onPress={() => {
        ...
        <View></View>
        <TouchableOpacity
          testID="categories-cart-btn"
          style={styles.cartIconContainer}
          onPress={() => navigation.navigate("cart")}
        >
          {cartproduct?.length > 0 ? (
            <View style={styles.cartItemCountContainer} testID="categories-cart-badge">
              <Text style={styles.cartItemCountText} testID="categories-cart-count">{cartproduct.length}</Text>
            </View>
          ) : (
            <></>
          )}
          <Image source={cartIcon} testID="categories-cart-icon" />
        </TouchableOpacity>
      </View>
      <View style={styles.bodyContainer}>
        ...
        <FlatList
          ...
          renderItem={({ item: tab }) => (
            <CustomIconButton
              ...
              text={tab.title}
              image={tab.image}
              testID={`categories-tab-${tab.title}`}
        ...
        {foundItems.filter(
          ...
          <View style={styles.noItemContainer}>
            ...
            >
              <Image
                testID="categories-empty-image"
                source={emptyBox}
                style={{ height: 80, width: 80, resizeMode: "contain" }}
              />
              <Text style={styles.emptyBoxText} testID="categories-empty-text">
          ...
          <FlatList
            testID="categories-products-list"
