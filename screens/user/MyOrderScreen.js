...
const MyOrderScreen = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.container} testID="my-orders-screen">
      <StatusBar testID="my-orders-status-bar"></StatusBar>
      <ProgressDialog visible={isloading} label={label} />
      <View style={styles.topBarContainer}>
        <TouchableOpacity
          testID="my-orders-back-btn"
          onPress={() => {
            navigation.goBack();
          }}
        >
        ...
        <View></View>
        <TouchableOpacity testID="my-orders-refresh-btn" onPress={() => handleOnRefresh()}>
          <Ionicons name="cart-outline" size={30} color={colors.primary} />
        </TouchableOpacity>
      </View>
      <View style={styles.screenNameContainer}>
        <View>
          <Text style={styles.screenNameText} testID="my-orders-heading">My Orders</Text>
        </View>
        <View>
